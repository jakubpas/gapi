...
class Connector
{
     ...
     * @return array of APIAccountEntry objects
     * @todo To check where $google_results comes from
     */
    protected function accountObjectMapper($xml_string)
    {
        $google_results = new \stdClass();
     ...
     * @param string $xml_string
     * @return array of APIReportEntry objects
     */
    ...
    /**
     * Get an array of the metrics and the matching aggregate values for the current result
     * @return array
     */
     ...
     * @param $parameters
     * @return string
     * @throws Exception if not a valid parameter or aggregate metric, or not a 'get' function
     */
